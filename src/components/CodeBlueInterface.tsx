/**
 * Interactive Code Blue kit drill — integrated from
 * origin/feature/interactive-code-blue (ChatGPT / ausdisau push).
 * Educational UI only; full canon PlayShell is at /code-blue.
 */
"use client";
...
const domainStyles: Record<Domain, string> = {
  ...
  breathing: "border-[var(--color-accent)] bg-[var(--color-accent-soft)] text-[var(--color-ink)]",
  circulation: "border-[var(--color-warning)] bg-[#f7efe6] text-[var(--color-ink)]",
  access: "border-emerald-700 bg-emerald-50 text-emerald-950",
  family: "border-[var(--color-line)] bg-[var(--color-wash)] text-[var(--color-ink)]",
};
...
export function CodeBlueInterface() {
  ...
  return (
    <div className="space-y-5">
      <p className="rounded-sm border border-[var(--color-line)] bg-[var(--color-wash)] px-3 py-2 text-sm text-[var(--color-muted)]">
        Kit drill from the ChatGPT interactive Code Blue push. For the content-pack
        + engine slice (Alarm After ROSC), use{" "}
        <Link href="/code-blue" className="font-medium text-[var(--color-accent)] underline">
          the PlayShell
        </Link>
        .
      </p>
      <div className="rounded-sm border-2 border-[var(--color-warning)] bg-[var(--color-warning)] px-4 py-3 text-white">
      ...
      <div className="grid gap-5 xl:grid-cols-[16rem_minmax(0,1fr)_20rem]">
        ...
        <aside className="space-y-4 rounded-sm border border-[var(--color-line)] bg-[var(--color-surface)] p-4">
          ...
          <section className="rounded-sm border border-[var(--color-line)] bg-[var(--color-wash)] p-3 text-sm text-[var(--color-ink)]">
